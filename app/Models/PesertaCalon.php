...
class PesertaCalon extends Authenticatable
{
    ...
    public function setPasswordAttribute($value)
    {
        ...
        // If the value looks like a hashed password (bcrypt/argon prefixes),
        // assume it's already hashed and store as-is. Otherwise, hash it.
        if (is_string($value) && preg_match('/^\$2y\$|^\$argon2i\$|^\$argon2id\$/', $value)) {
