            ...
            <div class="flex justify-center lg:justify-start">
                <div class="grid grid-cols-2 w-[400px]">
                    <div class="relative w-full pb-[100%]">
                        <img src="<?php echo e(asset('assets/landing/feature-1.jpg')); ?>" alt="Feature 1"
                            class="absolute inset-0 w-full h-full object-cover rounded-tl-[32px] rounded-br-[32px]">
                    </div>
                    <div class="relative w-full pb-[100%]">
                        <img src="<?php echo e(asset('assets/landing/feature-2.jpg')); ?>" alt="Feature 2"
                            class="absolute inset-0 w-full h-full object-cover rounded-tr-[32px] rounded-bl-[32px]">
                    </div>
                    <div class="relative w-full pb-[100%]">
                        <img src="<?php echo e(asset('assets/landing/feature-3.jpg')); ?>" alt="Feature 3"
                            class="absolute inset-0 w-full h-full object-cover rounded-tr-[32px] rounded-bl-[32px]">
                    </div>
                    <div class="relative w-full pb-[100%]">
                        <img src="<?php echo e(asset('assets/landing/feature-4.jpg')); ?>" alt="Feature 4"
                            class="absolute inset-0 w-full h-full object-cover rounded-tl-[32px] rounded-br-[32px]">
                    </div>
                </div>
            </div>
...
</section><?php /**PATH D:\Document\KULIAH\projectmagang\Morintern\resources\views/landing/components/features.blade.php ENDPATH**/ ?>