    ...
    <div class="max-w-[1440px] mx-auto px-8 lg:px-12">
            ...
            <div>
                ...
                <div class="flex items-center gap-5 mb-6">
                    <a href="https://www.instagram.com/morbis_official?igsh=aWtzYmFoNm5mYWUw"
                        ...
                        <img src="<?php echo e(asset('assets/landing/icon-ig.svg')); ?>" alt="instagram" class="w-7 h-7">
                    </a>
                    <a href="https://www.linkedin.com/company/pt-medika-digital-nusantara/"
                        class="p-2 bg-white/20 rounded-lg hover:bg-white/30 transition">
                        <img src="<?php echo e(asset('assets/landing/icon-linkedin.svg')); ?>" alt="linkedin" class="w-7 h-7">
                    </a>
                </div>
        ...
        <div class="mt-16 border-t border-white/20 pt-6 text-center">
            <p class="text-sm text-gray-100">
                &copy; <?php echo e(date('Y')); ?> <?php echo e(config('app.name')); ?>. MorIntern.
            </p>
        </div>

    </div>
</footer>
<?php /**PATH E:\2 - Magang Kampus\Morintern\Morintern\resources\views/landing/components/footer.blade.php ENDPATH**/ ?>